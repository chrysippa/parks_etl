with open('log.txt', 'a') as log:
    log.write('Now in create_dataframes.py. Importing modules.')
...
with open('log.txt', 'a') as log:
    log.write('Fetch park metadata from BQ')
try:
...
with open('log.txt', 'a') as log:
    log.write('Fetch special days from BQ')
try:
...
with open('log.txt', 'a') as log:
    log.write('Exiting create_dataframes.py')